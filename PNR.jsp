...
<div id="content">
						<div id="box1">
							<h3 align="center">
					  <div id="box1">
						   <form name="form1" method="post" action="Status.jsp">
							<h3 align="center" class="style5 style4"><font color="#993300">Enter the PNR for your booking below to get the current status.</font></h3>
							<p align="center" class="style2">
                              <input type="text" name="T1" />
						  </p>
						   
						      <table width="40" height="20" border="0" align="center">
                                <tr>
                                  <td width="-1"><label></label></td>
                                  <td width="50"><input type="submit" name="B1" value="GET STATUS" align="center" /></td>
						  ...
						  <div id="slideshow">
						    <div align="center" class="style3">
						      <h1><a href="Index.jsp"><strong>Back</strong></a></h1>
						    </div>
						  </div>
