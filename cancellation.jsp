...
<form method="post" action="cancellation1.jsp"><center>

<h2 align="center">
<table border="0" align="center">
<tr>
<td><font color=red size=4>Cancelation Form<tr></font>
<td>Enter Your Ticket Id&nbsp&nbsp&nbsp&nbsp&nbsp</td>
<td><input type="text"  min="5" name="ticketno" > </td>
</tr>
<tr>
<td></td>
