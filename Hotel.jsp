...
<div id="content">
  <div id="box1">
    <form id="form2" name="form2" method="post" action="FindHotel.jsp">
      <center>
        <table width="500" border="0">
          <tr>
            <td colspan="2"><div align="center">
                <h3 class="style2"><b><font color="#993300">Enter The Destination Address To Find The Corresponding Hotels</font></b> </h3>
            </div></td>
          </tr>
          <tr>
            <td width="229"><div align="center">
                <h3><b><font color="#993300">Destination Address</font></b></h3>
            </div></td>
            <td width="342"><label>
          ...
          <tr>
            <td><label></label>
                <div align="right">
                  <h5>
                    <input type="submit" name="Submit" value="Find Hotels" />
                  </h5>
                </div></td>
          </tr>
        </table>
